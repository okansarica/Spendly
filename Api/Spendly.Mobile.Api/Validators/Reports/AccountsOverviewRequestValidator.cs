// CHANGED_BY_AI: 2026-03-02 - Add accounts overview validation
...
public class AccountsOverviewRequestValidator : AbstractValidator<AccountsOverviewRequestViewModel>
{
    public AccountsOverviewRequestValidator()
    {
