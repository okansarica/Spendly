...
export default function ChangePasswordScreen() {
    ...
    const onSave = async () => {
        ...
        const result = await dispatch(changeUserPassword({currentPassword, newPassword, confirmNewPassword}));
    ...
    return (
        <View style={s.container}>
            ...
            <View style={s.content}>
                ...
                <TextInput value={confirmNewPassword} onChangeText={setConfirmNewPassword} secureTextEntry
                           style={s.input}/>
