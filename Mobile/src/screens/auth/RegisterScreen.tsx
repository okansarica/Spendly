...
const DEV_AUTO_FILL = __DEV__ && false;
...
export default function RegisterScreen() {
  ...
  const [password, setPassword] = useState(DEV_AUTO_FILL ? '' : '');
  ...
  const handlePlanSelection = async (selectedPlanType: 'Trial' | 'Monthly' | 'Yearly') => {
    const result = await dispatch(register({name: name.trim(), surname: surname.trim(), email: email.trim(), password, selectedPlanType: selectedPlanType as RegisterPlanType}));
