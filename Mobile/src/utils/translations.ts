...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    CategoryReportDescription: 'Analyze your spending by categories and track trends',
    AccountReport: 'Account Report',
    AccountReportDescription: 'Monitor your account balances and transaction history',
    MerchantReport: 'Merchant Report',
    MerchantReportDescription: 'View spending patterns across different merchants',
    MerchantDetail: 'Merchant Detail',
    TopMerchants: 'Top Merchants',
    AllMerchants: 'All Merchants',
    NoMerchantData: 'No merchant data',
    InvalidMerchantId: 'Invalid merchant',
    ...
    BanksAccountsDescription: 'Manage your bank accounts and track balances',
    CategoriesTitle: 'Categories',
    CategoriesDescription: 'Organize your expenses with custom categories',
    MerchantsTitle: 'Merchants',
    MerchantsDescription: 'View and manage your merchant relationships',
    ...
    NoMerchantsFilteredDescription: 'Try clearing filters or searching for a different name.',
    ClearFilters: 'Clear filters',
    NoMerchantsTitle: 'No merchants yet',
    NoMerchantsDescription: 'There are no merchants added. Tap to add a merchant.',
    ...
    FreePlanDescription: 'This plan is free but comes with limitations.',
    PlanLabel: '{planType} {duration}',
    ...
    SubscriptionWarningBannerText: 'You are using free plan, tap here to upgrade now.',
